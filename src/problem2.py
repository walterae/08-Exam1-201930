...
def test_factor_sum():
    ...
    # Test 1:
    expected = 11  # This is the correct answer.
    answer = factor_sum(28)
    print('Test 1 expected:', expected)
    print('       actual:  ', answer)

    # Test 2:
    expected = 4  # This is he correct answer.
    answer = factor_sum(25)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)

    # Test 3:
    expected = 3  # This is the correct answer.
    answer = factor_sum(6)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)

    # Test 4:
    expected = 4  # This is the correct answer.
    answer = factor_sum(9)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    # Test 5:
    expected = 9  # This is the correct answer.
